...
.method public static synthetic V(Lwa/u0;Lab/p;ILandroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lwa/u0;->d0(Lab/p;ILandroid/view/View;)V

    return-void
.end method

.method public static synthetic W(Lwa/u0;Lwa/k;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lwa/u0;->c0(Lwa/k;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic X(Lwa/u0;Landroid/view/View;Lab/p;ILandroid/view/MenuItem;)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lwa/u0;->e0(Landroid/view/View;Lab/p;ILandroid/view/MenuItem;)Z
...
.method public static synthetic Y(Lwa/u0;Lwa/k;Landroid/view/MenuItem;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lwa/u0;->f0(Lwa/k;Landroid/view/MenuItem;)Z
...
.method private Z(Lwa/k;)V
    ...
    invoke-direct {v0, p0, p1}, Lwa/q0;-><init>(Lwa/u0;Lwa/k;)V
...
.method private a0(Lwa/k;I)V
    .locals 8

    add-int/lit8 v0, p2, -0x1

    invoke-virtual {p0, v0}, Lwa/o0;->M(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lab/j;->getTitle()Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v5, v6}, Lyd/a;-><init>(Landroid/content/Context;II)V
    ...
    invoke-direct {v1, p0, v0, p2}, Lwa/r0;-><init>(Lwa/u0;Lab/p;I)V
...
.method private synthetic c0(Lwa/k;Landroid/view/View;)V
    .locals 2
    ...
    :cond_4
    :goto_0
    invoke-direct {p0, p1}, Lwa/u0;->l0(Lwa/k;)V

    goto :goto_2

    :cond_5
    :goto_1
    invoke-direct {p0, p2, p1}, Lwa/u0;->k0(Landroid/view/View;Lwa/k;)V
...
.method private synthetic d0(Lab/p;ILandroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lwa/u0;->i0(Lab/p;ILandroid/view/View;)V

    return-void
.end method

.method private synthetic e0(Landroid/view/View;Lab/p;ILandroid/view/MenuItem;)Z
    .locals 5
    ...
    invoke-direct {p3, p1}, Lsb/s;-><init>(Landroid/content/Context;)V

    invoke-virtual {p3, p2}, Lsb/s;->e(Lab/j;)Lsb/s;
    ...
    invoke-static {p2, p3, p1}, Lqb/d2;->E0(Ljava/util/ArrayList;ILandroid/content/Context;)V

    const-string p1, "play_on_phone"

    invoke-static {v4, v3, p1}, Lrb/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p3}, Lya/f0;->b(Ljava/util/ArrayList;)V

    iget-object p1, p0, Lwa/y0;->u:Lbb/y1;

    invoke-virtual {p1, p2}, Lbb/y1;->Q2(Lab/j;)V
    ...
    invoke-virtual {p1, p3}, Lbb/y1;->P2(Ljava/io/File;)V
...
.method private synthetic f0(Lwa/k;Landroid/view/MenuItem;)Z
    .locals 3
    ...
    invoke-virtual {p0, v2, p1}, Lwa/u0;->b0(II)V
    ...
    invoke-virtual {p0, p1, p2}, Lwa/u0;->b0(II)V
...
.method private i0(Lab/p;ILandroid/view/View;)V
    .locals 2
    ...
    invoke-direct {v0, v1, p3}, Landroidx/appcompat/widget/p1;-><init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Lwa/s0;-><init>(Lwa/u0;Landroid/view/View;Lab/p;I)V
...
.method private k0(Landroid/view/View;Lwa/k;)V
    ...
    invoke-direct {p1, p0, p2}, Lwa/t0;-><init>(Lwa/u0;Lwa/k;)V
...
.method private l0(Lwa/k;)V
    ...
    invoke-virtual {p0, p1, v0}, Lwa/u0;->b0(II)V
...
.method public bridge synthetic D(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-virtual {p0, p1, p2}, Lwa/u0;->g0(Landroid/view/ViewGroup;I)Lwa/k;
...
.method protected P(Lwa/k;I)V
    ...
    invoke-virtual {p0, p2}, Lwa/u0;->q(I)I

    move-result v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1}, Lwa/u0;->Z(Lwa/k;)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2}, Lwa/u0;->a0(Lwa/k;I)V
...
.method public g0(Landroid/view/ViewGroup;I)Lwa/k;
    .locals 3
