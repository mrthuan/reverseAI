...
.method private static c(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    invoke-static {}, Lcom/google/android/material/datepicker/w;->j()Landroid/icu/util/TimeZone;
...
.method static d(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    invoke-static {p0}, Lcom/google/android/material/datepicker/w;->l(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method private static e(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {}, Lcom/google/android/material/datepicker/w;->h()Ljava/util/TimeZone;
...
.method static f(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/w;->e(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method static i()Ljava/util/Calendar;
    ...
    invoke-static {}, Lcom/google/android/material/datepicker/w;->g()Lcom/google/android/material/datepicker/s;
...
.method private static j()Landroid/icu/util/TimeZone;
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/v;->a(Ljava/lang/String;)Landroid/icu/util/TimeZone;
...
.method static k()Ljava/util/Calendar;
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/w;->l(Ljava/util/Calendar;)Ljava/util/Calendar;
