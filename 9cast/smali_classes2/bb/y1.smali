...
.field private s0:Lqb/d1;

.field private t0:Lab/j;

.field private u0:Lwa/y0;
...
.method public static synthetic D2(Lab/k;Lab/k;)I
    .locals 0

    invoke-static {p0, p1}, Lbb/y1;->U2(Lab/k;Lab/k;)I
...
.method public static synthetic E2(Lbb/y1;Ljava/util/ArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lbb/y1;->Y2(Ljava/util/ArrayList;)V

    return-void
.end method

.method public static synthetic F2(Lbb/y1;Lwa/y0;)V
    .locals 0

    invoke-direct {p0, p1}, Lbb/y1;->a3(Lwa/y0;)V
...
.method public static synthetic G2(Lab/k;Lab/k;)I
    ...
    invoke-static {p0, p1}, Lbb/y1;->Z2(Lab/k;Lab/k;)I
...
.method public static synthetic H2(Lbb/y1;)V
    .locals 0

    invoke-direct {p0}, Lbb/y1;->b3()V

    return-void
.end method

.method public static synthetic J2(Lbb/y1;Ljava/util/ArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lbb/y1;->X2(Ljava/util/ArrayList;)V

    return-void
.end method

.method public static synthetic K2(Lbb/y1;)V
    .locals 0

    invoke-direct {p0}, Lbb/y1;->V2()V

    return-void
.end method

.method public static synthetic L2(Lbb/y1;Ljava/io/File;Landroid/content/DialogInterface;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lbb/y1;->T2(Ljava/io/File;Landroid/content/DialogInterface;I)V

    return-void
.end method

.method public static synthetic M2(Lbb/y1;Ljava/util/ArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lbb/y1;->W2(Ljava/util/ArrayList;)V
...
.method private N2()V
    ...
    iget-object v0, p0, Lbb/y1;->w0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lbb/y1;->w0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v2, v1}, Landroidx/recyclerview/widget/RecyclerView;->b1(I)V
    ...
    :cond_0
    iget-object v0, p0, Lbb/y1;->u0:Lwa/y0;

    instance-of v0, v0, Lwa/u0;
    ...
    invoke-direct/range {v1 .. v6}, Lxa/c;-><init>(IIIII)V

    invoke-virtual {v0, v7}, Landroidx/recyclerview/widget/RecyclerView;->h(Landroidx/recyclerview/widget/RecyclerView$o;)V
...
.method private O2()V
    ...
    iget-object v0, p0, Lbb/y1;->x0:Landroid/view/View;

    iget-object v1, p0, Lbb/y1;->u0:Lwa/y0;
...
.method private R2()Lwa/y0;
    ...
    invoke-direct {v0, v1, p0}, Lwa/x0;-><init>(Landroid/content/Context;Lbb/y1;)V
    ...
    invoke-direct {v0, v1, p0}, Lwa/u0;-><init>(Landroid/content/Context;Lbb/y1;)V

    :goto_0
    return-object v0
.end method

.method private S2()Landroidx/recyclerview/widget/RecyclerView$p;
    .locals 5
    ...
    new-instance v0, Lbb/y1$a;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->Z()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v0, p0, v3, v2, v1}, Lbb/y1$a;-><init>(Lbb/y1;Landroid/content/Context;IZ)V
    ...
    new-instance v1, Lbb/y1$b;

    invoke-direct {v1, p0}, Lbb/y1$b;-><init>(Lbb/y1;)V
...
.method private synthetic T2(Ljava/io/File;Landroid/content/DialogInterface;I)V
    ...
    iget-object p2, p0, Lbb/y1;->s0:Lqb/d1;
...
.method private static synthetic U2(Lab/k;Lab/k;)I
    .locals 0
...
.method private synthetic V2()V
    ...
    iget-object v0, p0, Lbb/y1;->v0:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;
    ...
    invoke-direct {p0}, Lbb/y1;->O2()V

    return-void
.end method

.method private synthetic W2(Ljava/util/ArrayList;)V
    .locals 3
    ...
    invoke-direct {v2}, Lbb/v1;-><init>()V

    invoke-static {v1, v2}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    :cond_1
    iget-object v2, p0, Lbb/y1;->u0:Lwa/y0;

    invoke-virtual {v2, v1}, Lwa/y0;->T(Ljava/util/ArrayList;)V

    iget-object v1, p0, Lbb/y1;->u0:Lwa/y0;

    invoke-virtual {v1, p1}, Lwa/o0;->R(Ljava/util/ArrayList;)V

    new-instance p1, Lbb/w1;

    invoke-direct {p1, p0}, Lbb/w1;-><init>(Lbb/y1;)V
...
.method private synthetic X2(Ljava/util/ArrayList;)V
    .locals 1
    ...
    iget-object p1, p0, Lbb/y1;->w0:Landroidx/recyclerview/widget/RecyclerView;
...
.method private synthetic Y2(Ljava/util/ArrayList;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lbb/s1;-><init>(Lbb/y1;Ljava/util/ArrayList;)V
...
.method private static synthetic Z2(Lab/k;Lab/k;)I
    .locals 0
...
.method private synthetic a3(Lwa/y0;)V
    .locals 2

    iget-object v0, p0, Lbb/y1;->w0:Landroidx/recyclerview/widget/RecyclerView;

    invoke-direct {p0}, Lbb/y1;->S2()Landroidx/recyclerview/widget/RecyclerView$p;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$p;)V

    iput-object p1, p0, Lbb/y1;->u0:Lwa/y0;

    iget-object v0, p0, Lbb/y1;->r0:Lab/k;
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lwa/y0;->U(Z)V

    invoke-direct {p0}, Lbb/y1;->N2()V
    ...
    iget-object p1, p0, Lbb/y1;->u0:Lwa/y0;
...
.method private synthetic b3()V
    ...
    invoke-direct {p0}, Lbb/y1;->R2()Lwa/y0;
    ...
    invoke-static {v1}, Lab/l;->b(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2}, Lbb/t1;-><init>()V

    invoke-static {v1, v2}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    :cond_0
    invoke-virtual {v0, v1}, Lwa/y0;->T(Ljava/util/ArrayList;)V
    ...
    invoke-direct {v2, p0, v0}, Lbb/u1;-><init>(Lbb/y1;Lwa/y0;)V
...
.method private c3(Z)V
    ...
    invoke-direct {v0, p0}, Lbb/q1;-><init>(Lbb/y1;)V

    invoke-static {v0, p1}, Lqb/d2;->Y(Lib/c;Z)V
...
.method public C()V
    ...
    invoke-direct {p0, v0}, Lbb/y1;->c3(Z)V
...
.method public J(I)V
    ...
    invoke-direct {v0, p0}, Lbb/r1;-><init>(Lbb/y1;)V
...
.method public P2(Ljava/io/File;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/appcompat/app/b$a;->g(I)Landroidx/appcompat/app/b$a;

    move-result-object v0

    new-instance v1, Lbb/x1;

    invoke-direct {v1, p0, p1}, Lbb/x1;-><init>(Lbb/y1;Ljava/io/File;)V
...
.method public Q2(Lab/j;)V
    ...
    :cond_0
    iput-object p1, p0, Lbb/y1;->t0:Lab/j;
    ...
    iget-object v0, p0, Lbb/y1;->t0:Lab/j;
...
.method public T0(IILandroid/content/Intent;)V
    ...
    iget-object v0, p0, Lbb/y1;->s0:Lqb/d1;
...
.method public Y0(Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, p0, p0}, Lqb/d1;-><init>(Landroidx/fragment/app/Fragment;Lqb/d1$b;)V

    iput-object p1, p0, Lbb/y1;->s0:Lqb/d1;
...
.method public d(Ljava/io/File;)V
    ...
    invoke-direct {p0, p1}, Lbb/y1;->c3(Z)V
...
.method public d1()V
    ...
    invoke-virtual {v0}, Lqb/d1;->L()V

    return-void
.end method

.method public d3(Lab/k;)V
    .locals 0

    iput-object p1, p0, Lbb/y1;->r0:Lab/k;
...
.method public f1()V
    ...
    invoke-static {p0}, Lbb/a2;->c(Lbb/z1;)V
...
.method public onDeviceReady(Lcom/inshot/cast/core/device/ConnectableDevice;)V
    ...
    iget-object p1, p0, Lbb/y1;->t0:Lab/j;
    ...
    iget-object v1, p0, Lbb/y1;->t0:Lab/j;
...
.method public onReceiveTitle(Lza/q;)V
    ...
    iget-object p1, p0, Lbb/y1;->r0:Lab/k;
...
.method public onViewTypeChange(Lza/r;)V
    .locals 0
    .annotation runtime Ldg/m;
    .end annotation
...
.method public q1(Landroid/view/Menu;)V
    ...
    iget-object v3, p0, Lbb/y1;->r0:Lab/k;
...
.method public w(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1}, Lbb/y1;->Q2(Lab/j;)V
...
.method public x1(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lbb/a2;->a(Lbb/z1;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroidx/fragment/app/Fragment;->j2(Z)V

    invoke-direct {p0}, Lbb/y1;->e3()Z
    ...
    iput-object v1, p0, Lbb/y1;->x0:Landroid/view/View;
    ...
    iput-object v1, p0, Lbb/y1;->v0:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;
    ...
    iget-object v1, p0, Lbb/y1;->v0:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;
    ...
    iput-object p1, p0, Lbb/y1;->w0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lbb/y1;->v0:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;
    ...
    new-instance v0, Lbb/p1;

    invoke-direct {v0, p0, p1}, Lbb/p1;-><init>(Lbb/y1;Ljava/util/ArrayList;)V
