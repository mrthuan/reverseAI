...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg/b;->a:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lg/b;->b:Ljava/util/WeakHashMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lg/b;->c:Ljava/lang/Object;
...
.method private static a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    sget-object v0, Lg/b;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lg/b;->b:Ljava/util/WeakHashMap;
    ...
    invoke-direct {v1, p2, p0}, Lg/b$a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;)V
...
.method private static b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast v2, Lg/b$a;

    if-eqz v2, :cond_1

    iget-object v3, v2, Lg/b$a;->b:Landroid/content/res/Configuration;
    ...
    iget-object p0, v2, Lg/b$a;->a:Landroid/content/res/ColorStateList;
...
.method public static c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-static {p0, p1}, Lg/b;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-static {p0, p1}, Lg/b;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-static {p0, p1, v0}, Lg/b;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
...
.method public static d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/appcompat/widget/q1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private static e()Landroid/util/TypedValue;
    ...
    sget-object v0, Lg/b;->a:Ljava/lang/ThreadLocal;
...
.method private static f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, p1}, Lg/b;->g(Landroid/content/Context;I)Z
...
.method private static g(Landroid/content/Context;I)Z
    ...
    invoke-static {}, Lg/b;->e()Landroid/util/TypedValue;
