...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lp0/a;->a(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    :goto_0
    invoke-virtual {p0, p2}, Landroid/support/v4/media/session/MediaSessionCompat;->h(Landroid/support/v4/media/session/MediaSessionCompat$c;)V

    invoke-interface {p3, p4}, Landroid/support/v4/media/session/MediaSessionCompat$d;->h(Landroid/app/PendingIntent;)V
...
.method static d(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$b;->a()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public b()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->i()Ljava/lang/Object;
...
.method public c()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$d;->f()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public g(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->j(Z)V
...
.method public h(Landroid/support/v4/media/session/MediaSessionCompat$c;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat;->i(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V

    return-void
.end method

.method public i(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    .locals 1
    ...
    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->g(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->g(Landroid/support/v4/media/session/MediaSessionCompat$c;Landroid/os/Handler;)V
...
.method public j(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$d;->e(I)V
