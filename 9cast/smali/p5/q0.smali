...
.method public final h()Lp5/s4;
    ...
    sget-object v1, Lp5/s4;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public final j()Lp5/m2;
    ...
    :cond_1
    new-instance v2, Lp5/k2;

    invoke-direct {v2, v1}, Lp5/k2;-><init>(Landroid/os/IBinder;)V
...
.method public final l()Lp5/p2;
    ...
    instance-of v3, v2, Lp5/p2;

    if-eqz v3, :cond_1

    move-object v1, v2

    check-cast v1, Lp5/p2;

    goto :goto_0

    :cond_1
    new-instance v2, Lp5/n2;

    invoke-direct {v2, v1}, Lp5/n2;-><init>(Landroid/os/IBinder;)V
