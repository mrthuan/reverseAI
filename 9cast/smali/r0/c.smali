...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lr0/c;->f:Ljava/io/File;

    iput-object p2, p0, Lr0/c;->q:Ljava/io/File;

    invoke-static {p1}, Lr0/c;->v(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lr0/c;->p:J
    ...
    iput-object p2, p0, Lr0/c;->r:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lr0/c;->s:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lr0/c;->t:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lr0/c;->s:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lr0/c;->d(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lr0/c;->r:Ljava/io/RandomAccessFile;
...
.method private H(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    .locals 16
    ...
    iget-object v3, v0, Lr0/c;->f:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lr0/c;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lr0/c$b;

    iget-object v9, v0, Lr0/c;->q:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lr0/c$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lr0/c;->v(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lr0/c$b;->f:J
...
.method private I()Ljava/util/List;
    ...
    iget-object v6, v1, Lr0/c;->f:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Lr0/c;->a()V
    ...
    iget-object v0, v1, Lr0/c;->f:Ljava/io/File;
    ...
    iget-object v12, v1, Lr0/c;->q:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lr0/c$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v11, v6}, Lr0/c;->e(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lr0/c;->v(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lr0/c$b;->f:J
    :try_end_1
...
.method private static J(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lr0/c;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method private a()V
    ...
    iget-object v0, p0, Lr0/c;->q:Ljava/io/File;

    new-instance v1, Lr0/c$a;

    invoke-direct {v1, p0}, Lr0/c$a;-><init>(Lr0/c;)V
    ...
    iget-object v2, p0, Lr0/c;->q:Ljava/io/File;
...
.method private static e(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lr0/c;->d(Ljava/io/Closeable;)V
...
.method private static v(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lr0/d;->c(Ljava/io/File;)J
...
.method private static x(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7
    ...
    invoke-static {p1}, Lr0/c;->j(Ljava/io/File;)J
...
# virtual methods
.method G(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lr0/c;->f:Ljava/io/File;
    ...
    iget-object v0, p0, Lr0/c;->t:Ljava/nio/channels/FileLock;
    ...
    iget-object v0, p0, Lr0/c;->f:Ljava/io/File;

    iget-wide v2, p0, Lr0/c;->p:J

    invoke-static {p1, v0, v2, v3, p2}, Lr0/c;->x(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lr0/c;->H(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Lr0/c;->I()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Lr0/c;->f:Ljava/io/File;

    invoke-static {v0}, Lr0/c;->j(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lr0/c;->p:J
    ...
    invoke-static/range {v2 .. v8}, Lr0/c;->J(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    iget-object v0, p0, Lr0/c;->s:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/spi/AbstractInterruptibleChannel;->close()V

    iget-object v0, p0, Lr0/c;->r:Ljava/io/RandomAccessFile;
