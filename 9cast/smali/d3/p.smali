...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-static {p1}, Ld3/p;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    :goto_1
    invoke-static {p1, p0}, Ld3/p;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static b(Landroid/graphics/Bitmap;Lv2/b;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    :cond_3
    invoke-static {p0}, Ld3/p;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v5

    invoke-interface {p1, v3, v4, v5}, Lv2/b;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    invoke-static {p0, p1}, Ld3/p;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static f(Landroid/graphics/Bitmap;Lv2/b;I)Landroid/graphics/Bitmap;
    .locals 4
    ...
    invoke-static {p2, v0}, Ld3/p;->e(ILandroid/graphics/Matrix;)V
    ...
    invoke-interface {p1, v1, v2, v3}, Lv2/b;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
