...
.field n:Lj$/util/concurrent/C;

.field o:Lj$/util/concurrent/C;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/C;Ljava/util/function/ToDoubleFunction;DLjava/util/function/DoubleBinaryOperator;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/C;->o:Lj$/util/concurrent/C;

    iput-object p7, p0, Lj$/util/concurrent/C;->j:Ljava/util/function/ToDoubleFunction;

    iput-wide p8, p0, Lj$/util/concurrent/C;->l:D

    iput-object p10, p0, Lj$/util/concurrent/C;->k:Ljava/util/function/DoubleBinaryOperator;
...
.method public final compute()V
    ...
    iget-object v12, v11, Lj$/util/concurrent/C;->j:Ljava/util/function/ToDoubleFunction;

    if-eqz v12, :cond_3

    iget-object v13, v11, Lj$/util/concurrent/C;->k:Ljava/util/function/DoubleBinaryOperator;

    if-eqz v13, :cond_3

    iget-wide v14, v11, Lj$/util/concurrent/C;->l:D
    ...
    new-instance v8, Lj$/util/concurrent/C;
    ...
    iget-object v6, v11, Lj$/util/concurrent/C;->n:Lj$/util/concurrent/C;
    ...
    iput-object v12, v11, Lj$/util/concurrent/C;->n:Lj$/util/concurrent/C;
    ...
    :cond_1
    iput-wide v14, v11, Lj$/util/concurrent/C;->m:D
    ...
    iget-object v2, v1, Lj$/util/concurrent/C;->n:Lj$/util/concurrent/C;

    :goto_3
    if-eqz v2, :cond_2

    iget-wide v3, v1, Lj$/util/concurrent/C;->m:D

    iget-wide v5, v2, Lj$/util/concurrent/C;->m:D
    ...
    iput-wide v3, v1, Lj$/util/concurrent/C;->m:D

    iget-object v2, v2, Lj$/util/concurrent/C;->o:Lj$/util/concurrent/C;

    iput-object v2, v1, Lj$/util/concurrent/C;->n:Lj$/util/concurrent/C;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-wide v0, p0, Lj$/util/concurrent/C;->m:D
