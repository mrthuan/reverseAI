...
.field m:Lj$/util/concurrent/t;

.field n:Lj$/util/concurrent/t;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/t;Ljava/util/function/Function;Ljava/util/function/BiFunction;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/t;->n:Lj$/util/concurrent/t;

    iput-object p7, p0, Lj$/util/concurrent/t;->j:Ljava/util/function/Function;

    iput-object p8, p0, Lj$/util/concurrent/t;->k:Ljava/util/function/BiFunction;
...
.method public final compute()V
    ...
    iget-object v9, p0, Lj$/util/concurrent/t;->j:Ljava/util/function/Function;

    if-eqz v9, :cond_7

    iget-object v10, p0, Lj$/util/concurrent/t;->k:Ljava/util/function/BiFunction;
    ...
    new-instance v12, Lj$/util/concurrent/t;
    ...
    iget-object v6, p0, Lj$/util/concurrent/t;->m:Lj$/util/concurrent/t;
    ...
    iput-object v12, p0, Lj$/util/concurrent/t;->m:Lj$/util/concurrent/t;
    ...
    :cond_3
    iput-object v0, p0, Lj$/util/concurrent/t;->l:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lj$/util/concurrent/t;->m:Lj$/util/concurrent/t;

    :goto_4
    if-eqz v2, :cond_6

    iget-object v3, v2, Lj$/util/concurrent/t;->l:Ljava/lang/Object;

    if-eqz v3, :cond_5

    iget-object v4, v1, Lj$/util/concurrent/t;->l:Ljava/lang/Object;
    ...
    :goto_5
    iput-object v3, v1, Lj$/util/concurrent/t;->l:Ljava/lang/Object;

    :cond_5
    iget-object v2, v2, Lj$/util/concurrent/t;->n:Lj$/util/concurrent/t;

    iput-object v2, v1, Lj$/util/concurrent/t;->m:Lj$/util/concurrent/t;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lj$/util/concurrent/t;->l:Ljava/lang/Object;
