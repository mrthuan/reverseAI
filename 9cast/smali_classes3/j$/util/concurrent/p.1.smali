...
# instance fields
.field final j:Ljava/util/function/Function;

.field final k:Ljava/util/function/BiFunction;

.field l:Ljava/lang/Object;

.field m:Lj$/util/concurrent/p;

.field n:Lj$/util/concurrent/p;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/p;Ljava/util/function/Function;Ljava/util/function/BiFunction;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/p;->n:Lj$/util/concurrent/p;

    iput-object p7, p0, Lj$/util/concurrent/p;->j:Ljava/util/function/Function;

    iput-object p8, p0, Lj$/util/concurrent/p;->k:Ljava/util/function/BiFunction;
...
.method public final compute()V
    ...
    iget-object v9, p0, Lj$/util/concurrent/p;->j:Ljava/util/function/Function;

    if-eqz v9, :cond_7

    iget-object v10, p0, Lj$/util/concurrent/p;->k:Ljava/util/function/BiFunction;
    ...
    new-instance v12, Lj$/util/concurrent/p;
    ...
    iget-object v6, p0, Lj$/util/concurrent/p;->m:Lj$/util/concurrent/p;
    ...
    iput-object v12, p0, Lj$/util/concurrent/p;->m:Lj$/util/concurrent/p;
    ...
    :cond_3
    iput-object v0, p0, Lj$/util/concurrent/p;->l:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lj$/util/concurrent/p;->m:Lj$/util/concurrent/p;

    :goto_4
    if-eqz v2, :cond_6

    iget-object v3, v2, Lj$/util/concurrent/p;->l:Ljava/lang/Object;

    if-eqz v3, :cond_5

    iget-object v4, v1, Lj$/util/concurrent/p;->l:Ljava/lang/Object;
    ...
    :goto_5
    iput-object v3, v1, Lj$/util/concurrent/p;->l:Ljava/lang/Object;

    :cond_5
    iget-object v2, v2, Lj$/util/concurrent/p;->n:Lj$/util/concurrent/p;

    iput-object v2, v1, Lj$/util/concurrent/p;->m:Lj$/util/concurrent/p;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lj$/util/concurrent/p;->l:Ljava/lang/Object;
