...
.field n:Lj$/util/concurrent/s;

.field o:Lj$/util/concurrent/s;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/s;Ljava/util/function/ToLongFunction;JLjava/util/function/LongBinaryOperator;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/s;->o:Lj$/util/concurrent/s;

    iput-object p7, p0, Lj$/util/concurrent/s;->j:Ljava/util/function/ToLongFunction;

    iput-wide p8, p0, Lj$/util/concurrent/s;->l:J

    iput-object p10, p0, Lj$/util/concurrent/s;->k:Ljava/util/function/LongBinaryOperator;
...
.method public final compute()V
    ...
    iget-object v12, v11, Lj$/util/concurrent/s;->j:Ljava/util/function/ToLongFunction;

    if-eqz v12, :cond_3

    iget-object v13, v11, Lj$/util/concurrent/s;->k:Ljava/util/function/LongBinaryOperator;

    if-eqz v13, :cond_3

    iget-wide v14, v11, Lj$/util/concurrent/s;->l:J
    ...
    iget-object v6, v11, Lj$/util/concurrent/s;->n:Lj$/util/concurrent/s;
    ...
    iput-object v12, v11, Lj$/util/concurrent/s;->n:Lj$/util/concurrent/s;
    ...
    :cond_1
    iput-wide v14, v11, Lj$/util/concurrent/s;->m:J
    ...
    check-cast v1, Lj$/util/concurrent/s;

    iget-object v2, v1, Lj$/util/concurrent/s;->n:Lj$/util/concurrent/s;

    :goto_3
    if-eqz v2, :cond_2

    iget-wide v3, v1, Lj$/util/concurrent/s;->m:J

    iget-wide v5, v2, Lj$/util/concurrent/s;->m:J
    ...
    iput-wide v3, v1, Lj$/util/concurrent/s;->m:J

    iget-object v2, v2, Lj$/util/concurrent/s;->o:Lj$/util/concurrent/s;

    iput-object v2, v1, Lj$/util/concurrent/s;->n:Lj$/util/concurrent/s;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-wide v0, p0, Lj$/util/concurrent/s;->m:J
