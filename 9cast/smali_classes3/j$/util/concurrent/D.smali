...
.field n:Lj$/util/concurrent/D;

.field o:Lj$/util/concurrent/D;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/D;Ljava/util/function/ToIntFunction;ILjava/util/function/IntBinaryOperator;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/D;->o:Lj$/util/concurrent/D;

    iput-object p7, p0, Lj$/util/concurrent/D;->j:Ljava/util/function/ToIntFunction;

    iput p8, p0, Lj$/util/concurrent/D;->l:I

    iput-object p9, p0, Lj$/util/concurrent/D;->k:Ljava/util/function/IntBinaryOperator;
...
.method public final compute()V
    ...
    iget-object v10, p0, Lj$/util/concurrent/D;->j:Ljava/util/function/ToIntFunction;

    if-eqz v10, :cond_3

    iget-object v11, p0, Lj$/util/concurrent/D;->k:Ljava/util/function/IntBinaryOperator;

    if-eqz v11, :cond_3

    iget v12, p0, Lj$/util/concurrent/D;->l:I
    ...
    new-instance v14, Lj$/util/concurrent/D;
    ...
    iget-object v6, p0, Lj$/util/concurrent/D;->n:Lj$/util/concurrent/D;
    ...
    iput-object v14, p0, Lj$/util/concurrent/D;->n:Lj$/util/concurrent/D;
    ...
    :cond_1
    iput v12, p0, Lj$/util/concurrent/D;->m:I
    ...
    iget-object v2, v1, Lj$/util/concurrent/D;->n:Lj$/util/concurrent/D;

    :goto_3
    if-eqz v2, :cond_2

    iget v3, v1, Lj$/util/concurrent/D;->m:I

    iget v4, v2, Lj$/util/concurrent/D;->m:I
    ...
    iput v3, v1, Lj$/util/concurrent/D;->m:I

    iget-object v2, v2, Lj$/util/concurrent/D;->o:Lj$/util/concurrent/D;

    iput-object v2, v1, Lj$/util/concurrent/D;->n:Lj$/util/concurrent/D;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget v0, p0, Lj$/util/concurrent/D;->m:I
