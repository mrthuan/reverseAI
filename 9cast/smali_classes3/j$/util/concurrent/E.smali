...
.field n:Lj$/util/concurrent/E;

.field o:Lj$/util/concurrent/E;


# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/E;Ljava/util/function/ToLongFunction;JLjava/util/function/LongBinaryOperator;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lj$/util/concurrent/b;-><init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;)V

    iput-object p6, p0, Lj$/util/concurrent/E;->o:Lj$/util/concurrent/E;

    iput-object p7, p0, Lj$/util/concurrent/E;->j:Ljava/util/function/ToLongFunction;

    iput-wide p8, p0, Lj$/util/concurrent/E;->l:J

    iput-object p10, p0, Lj$/util/concurrent/E;->k:Ljava/util/function/LongBinaryOperator;
...
.method public final compute()V
    ...
    iget-object v12, v11, Lj$/util/concurrent/E;->j:Ljava/util/function/ToLongFunction;

    if-eqz v12, :cond_3

    iget-object v13, v11, Lj$/util/concurrent/E;->k:Ljava/util/function/LongBinaryOperator;

    if-eqz v13, :cond_3

    iget-wide v14, v11, Lj$/util/concurrent/E;->l:J
    ...
    new-instance v8, Lj$/util/concurrent/E;
    ...
    iget-object v6, v11, Lj$/util/concurrent/E;->n:Lj$/util/concurrent/E;
    ...
    iput-object v12, v11, Lj$/util/concurrent/E;->n:Lj$/util/concurrent/E;
    ...
    :cond_1
    iput-wide v14, v11, Lj$/util/concurrent/E;->m:J
    ...
    check-cast v1, Lj$/util/concurrent/E;

    iget-object v2, v1, Lj$/util/concurrent/E;->n:Lj$/util/concurrent/E;

    :goto_3
    if-eqz v2, :cond_2

    iget-wide v3, v1, Lj$/util/concurrent/E;->m:J

    iget-wide v5, v2, Lj$/util/concurrent/E;->m:J
    ...
    iput-wide v3, v1, Lj$/util/concurrent/E;->m:J

    iget-object v2, v2, Lj$/util/concurrent/E;->o:Lj$/util/concurrent/E;

    iput-object v2, v1, Lj$/util/concurrent/E;->n:Lj$/util/concurrent/E;
...
.method public final getRawResult()Ljava/lang/Object;
    ...
    iget-wide v0, p0, Lj$/util/concurrent/E;->m:J
