...
.field c:Lj$/util/stream/l0;

.field final synthetic d:Lj$/util/stream/z;


# direct methods
.method constructor <init>(Lj$/util/stream/z;Lj$/util/stream/v2;)V
    .locals 0

    iput-object p1, p0, Lj$/util/stream/n0;->d:Lj$/util/stream/z;

    invoke-direct {p0, p2}, Lj$/util/stream/q2;-><init>(Lj$/util/stream/v2;)V

    iget-object p1, p0, Lj$/util/stream/q2;->a:Lj$/util/stream/v2;
    ...
    iput-object p2, p0, Lj$/util/stream/n0;->c:Lj$/util/stream/l0;
...
.method public final accept(J)V
    ...
    iget-object v0, p0, Lj$/util/stream/n0;->d:Lj$/util/stream/z;
    ...
    :try_start_0
    iget-boolean p2, p0, Lj$/util/stream/n0;->b:Z
    ...
    iget-object v0, p0, Lj$/util/stream/n0;->c:Lj$/util/stream/l0;

    invoke-interface {p2, v0}, Lj$/util/stream/u0;->forEach(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {p2}, Lj$/util/stream/u0;->spliterator()Lj$/util/L;
...
.method public final e()Z
    ...
    iput-boolean v0, p0, Lj$/util/stream/n0;->b:Z
