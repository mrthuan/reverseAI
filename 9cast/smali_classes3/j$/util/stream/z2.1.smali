...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/z2;->s:J

    iput-wide p5, p0, Lj$/util/stream/z2;->t:J
...
.method static e1(Lj$/util/I;JJJ)Lj$/util/I;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/K3;-><init>(Lj$/util/I;JJ)V
...
.method final T0(Lj$/util/S;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/M0;
    ...
    iget-wide v4, v9, Lj$/util/stream/z2;->s:J
    ...
    invoke-static {p2, v0, v10}, Lj$/util/stream/D0;->c0(Lj$/util/stream/D0;Lj$/util/S;Z)Lj$/util/stream/J0;
    ...
    iget-wide v1, v9, Lj$/util/stream/z2;->s:J

    iget-wide v3, v9, Lj$/util/stream/z2;->t:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/z2;->e1(Lj$/util/I;JJJ)Lj$/util/I;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/D0;->c0(Lj$/util/stream/D0;Lj$/util/S;Z)Lj$/util/stream/J0;
    ...
    iget-wide v7, v9, Lj$/util/stream/z2;->s:J

    iget-wide v11, v9, Lj$/util/stream/z2;->t:J
...
.method final U0(Lj$/util/stream/c;Lj$/util/S;)Lj$/util/S;
    ...
    iget-wide v9, p0, Lj$/util/stream/z2;->s:J

    iget-wide p1, p0, Lj$/util/stream/z2;->t:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/D3;-><init>(Lj$/util/I;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/z2;->s:J

    iget-wide v3, p0, Lj$/util/stream/z2;->t:J
    ...
    iget-wide v5, p0, Lj$/util/stream/z2;->s:J

    iget-wide v7, p0, Lj$/util/stream/z2;->t:J
...
.method final W0(ILj$/util/stream/v2;)Lj$/util/stream/v2;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/y2;-><init>(Lj$/util/stream/z2;Lj$/util/stream/v2;)V
