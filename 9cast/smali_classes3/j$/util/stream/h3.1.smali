...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/h3;->a:Lj$/util/stream/Stream;
...
.method public static synthetic k(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/g3;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/g3;

    iget-object p0, p0, Lj$/util/stream/g3;->a:Ljava/util/stream/Stream;
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/h3;-><init>(Lj$/util/stream/Stream;)V
...
.method public final synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/util/stream/h3;->a:Lj$/util/stream/Stream;
...
.method public final synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/util/stream/l;->a(Ljava/util/stream/Collector;)Lj$/util/stream/Collector;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Lj$/util/stream/h3;

    if-eqz v1, :cond_0

    check-cast p1, Lj$/util/stream/h3;

    iget-object p1, p1, Lj$/util/stream/h3;->a:Lj$/util/stream/Stream;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/l;->e(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/D0;->r0(Ljava/util/function/Function;)Lj$/util/stream/a;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->x(Lj$/util/stream/a;)Lj$/util/stream/I;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->t(Lj$/util/stream/a;)Lj$/util/stream/k0;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->p(Lj$/util/stream/a;)Lj$/util/stream/u0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToDouble(Ljava/util/function/ToDoubleFunction;)Lj$/util/stream/I;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToInt(Ljava/util/function/ToIntFunction;)Lj$/util/stream/k0;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToLong(Ljava/util/function/ToLongFunction;)Lj$/util/stream/u0;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/l;->e(Lj$/util/Optional;)Ljava/util/Optional;
