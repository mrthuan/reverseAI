...
# virtual methods
.method public e(Lj$/time/chrono/n;Lj$/time/temporal/q;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Lj$/time/format/B;->f(Lj$/time/temporal/q;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
...
.method public f(Lj$/time/temporal/q;JLj$/time/format/G;Ljava/util/Locale;)Ljava/lang/String;
    .locals 0

    invoke-static {p1, p5}, Lj$/time/format/B;->b(Lj$/time/temporal/q;Ljava/util/Locale;)Ljava/lang/Object;
...
.method public g(Lj$/time/chrono/n;Lj$/time/temporal/q;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
    .locals 1
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2, p3, p4}, Lj$/time/format/B;->h(Lj$/time/temporal/q;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
...
.method public h(Lj$/time/temporal/q;Lj$/time/format/G;Ljava/util/Locale;)Ljava/util/Iterator;
    .locals 0

    invoke-static {p1, p3}, Lj$/time/format/B;->b(Lj$/time/temporal/q;Ljava/util/Locale;)Ljava/lang/Object;
