...
.method static b(Ljava/io/DataInput;)Lj$/time/zone/e;
    ...
    invoke-static {v10, v11}, Lj$/time/l;->a0(J)Lj$/time/l;
    ...
    invoke-static {v10}, Lj$/time/l;->X(I)Lj$/time/l;
    ...
    :cond_7
    :goto_6
    invoke-virtual {v10}, Lj$/time/l;->V()I
...
.method public final a(I)Lj$/time/zone/b;
    ...
    invoke-virtual {v4, v5, v6}, Lj$/time/chrono/u;->O(J)Z

    move-result v4

    invoke-virtual {v1, v4}, Lj$/time/n;->R(Z)I
    ...
    invoke-static {p1, v1, v4}, Lj$/time/LocalDate;->d0(ILj$/time/n;I)Lj$/time/LocalDate;
    ...
    :cond_0
    invoke-static {p1, v1, v3}, Lj$/time/LocalDate;->d0(ILj$/time/n;I)Lj$/time/LocalDate;
    ...
    invoke-direct {v1, v0, v3}, Lj$/time/temporal/n;-><init>(II)V

    :goto_0
    invoke-virtual {p1, v1}, Lj$/time/LocalDate;->n0(Lj$/time/temporal/m;)Lj$/time/LocalDate;
    ...
    invoke-virtual {p1, v2, v3}, Lj$/time/LocalDateTime;->d0(J)Lj$/time/LocalDateTime;
...
.method final c(Ljava/io/DataOutput;)V
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/time/l;->i0()I
    ...
    invoke-virtual {v12}, Lj$/time/n;->getValue()I
