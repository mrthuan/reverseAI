...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v4, v1, v3}, Lj$/time/chrono/A;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, v3}, Lj$/time/LocalDate;->c0(III)Lj$/time/LocalDate;
    ...
    invoke-direct {v1, v4, v3, v5}, Lj$/time/chrono/A;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v5}, Lj$/time/LocalDate;->c0(III)Lj$/time/LocalDate;

    move-result-object v5

    const-string v6, "Showa"

    invoke-direct {v3, v2, v5, v6}, Lj$/time/chrono/A;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v6, v2, v7}, Lj$/time/LocalDate;->c0(III)Lj$/time/LocalDate;
    ...
    invoke-direct {v5, v7, v6, v8}, Lj$/time/chrono/A;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v2}, Lj$/time/LocalDate;->c0(III)Lj$/time/LocalDate;
    ...
    invoke-direct {v6, v10, v8, v11}, Lj$/time/chrono/A;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
...
.method private constructor <init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
...
.method static i(Lj$/time/LocalDate;)Lj$/time/chrono/A;
    .locals 4

    sget-object v0, Lj$/time/chrono/z;->d:Lj$/time/LocalDate;

    invoke-virtual {p0, v0}, Lj$/time/LocalDate;->Y(Lj$/time/LocalDate;)Z
    ...
    iget-object v3, v2, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;

    invoke-virtual {p0, v3}, Lj$/time/LocalDate;->N(Lj$/time/chrono/c;)I
...
.method static j()Lj$/time/chrono/A;
    .locals 2
...
.method static t()J
    ...
    iget-object v6, v5, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;

    invoke-virtual {v6}, Lj$/time/LocalDate;->M()I

    move-result v6

    iget-object v7, v5, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
    ...
    invoke-virtual {v5}, Lj$/time/chrono/A;->o()Lj$/time/chrono/A;
    ...
    iget-object v5, v5, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
...
.method static u()J
    ...
    iget-object v0, v0, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
    ...
    iget-object v2, v2, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
    ...
    invoke-virtual {v6}, Lj$/time/LocalDate;->X()I
    ...
    iget-object v2, v5, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;
...
.method public static v()[Lj$/time/chrono/A;
    .locals 2
...
.method public final m(Lj$/time/temporal/q;)Lj$/time/temporal/u;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/x;->s(Lj$/time/temporal/a;)Lj$/time/temporal/u;
...
.method final n()Lj$/time/LocalDate;
    ...
    iget-object v0, p0, Lj$/time/chrono/A;->b:Lj$/time/LocalDate;

    return-object v0
.end method

.method final o()Lj$/time/chrono/A;
    .locals 1
